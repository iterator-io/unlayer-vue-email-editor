...
function getTargetType(value) {
  return value["__v_skip" /* SKIP */] || !Object.isExtensible(value) ? 0 /* INVALID */ : targetTypeMap(shared_esm_bundler_toRawType(value));
}
...
function createBaseVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, shapeFlag = type === Fragment ? 0 : 1 /* ELEMENT */, isBlockNode = false, needFullChildrenNormalization = false) {
  ...
  if (needFullChildrenNormalization) {
    ...
    // string or Array.
    vnode.shapeFlag |= shared_esm_bundler_isString(children) ? 8 /* TEXT_CHILDREN */ : 16 /* ARRAY_CHILDREN */;
  }
  // validate key
  if (false) {}
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  const shapeFlag = shared_esm_bundler_isString(type) ? 1 /* ELEMENT */ : isSuspense(type) ? 128 /* SUSPENSE */ : isTeleport(type) ? 64 /* TELEPORT */ : shared_esm_bundler_isObject(type) ? 4 /* STATEFUL_COMPONENT */ : isFunction(type) ? 2 /* FUNCTIONAL_COMPONENT */ : 0;
  if (false) {}
...
function findDir(node, name, allowEmpty = false) {
  for (let i = 0; i < node.props.length; i++) {
    ...
    if (p.type === 7 /* DIRECTIVE */ && (allowEmpty || p.exp) && (shared_esm_bundler_isString(name) ? p.name === name : name.test(p.name))) {
      return p;
    }
  }
}
...
function hasDynamicKeyVBind(node) {
  return node.props.some(p => p.type === 7 /* DIRECTIVE */ && p.name === 'bind' && (!p.arg ||
  // v-bind="obj"
...
function getUnnormalizedProps(props, callPath = []) {
  if (props && !shared_esm_bundler_isString(props) && props.type === 14 /* JS_CALL_EXPRESSION */) {
...
function walk(node, context, doNotHoistNode = false) {
    ...
    if (child.type === 1 /* ELEMENT */ && child.tagType === 0 /* ELEMENT */) {
      ...
      if (constantType > 0 /* NOT_CONSTANT */) {
        if (constantType >= 2 /* CAN_HOIST */) {
          child.codegenNode.patchFlag = -1 /* HOISTED */ + ( false ? 0 : ``);
  ...
  if (hoistedCount && hoistedCount === originalCount && node.type === 1 /* ELEMENT */ && node.tagType === 0 /* ELEMENT */ && node.codegenNode && node.codegenNode.type === 13 /* VNODE_CALL */ && shared_esm_bundler_isArray(node.codegenNode.children)) {
...
function getConstantTypeOfHelperCall(value, context) {
  if (value.type === 14 /* JS_CALL_EXPRESSION */ && !shared_esm_bundler_isString(value.callee) && allowHoistedHelperSet.has(value.callee)) {
  ...
  return processFor(node, dir, context, forNode => {
    ...
    return () => {
      ...
      if (slotOutlet) {
        ...
        childBlock = createVNodeCall(context, helper(FRAGMENT), keyProperty ? createObjectExpression([keyProperty]) : undefined, node.children, 64 /* STABLE_FRAGMENT */ + ( false ? 0 : ``), undefined, undefined, true, undefined, false /* isComponent */);
      } else {
...
function buildProps(node, context, props = node.props, isComponent, isDynamicComponent, ssr = false) {
  ...
  for (let i = 0; i < props.length; i++) {
    ...
    if (prop.type === 6 /* ATTRIBUTE */) {
      ...
      if (name === 'is' || isVBind && isStaticArgOf(arg, 'is') && (isComponentTag(tag) || isCompatEnabled("COMPILER_IS_ON_ELEMENT" /* COMPILER_IS_ON_ELEMENT */, context))) {
        continue;
      }
...
const resolveModifiers = (key, modifiers, context, loc) => {
  ...
  for (let i = 0; i < modifiers.length; i++) {
    ...
    if (modifier === 'native' && checkCompatEnabled("COMPILER_V_ON_NATIVE" /* COMPILER_V_ON_NATIVE */, context, loc)) {
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/EmailEditor.vue?vue&type=template&id=0095b5af&scoped=true

const _withScopeId = n => (_pushScopeId("data-v-0095b5af"), n = n(), _popScopeId(), n);
const _hoisted_1 = ["id"];
function EmailEditorvue_type_template_id_0095b5af_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
...
;// CONCATENATED MODULE: ./src/components/EmailEditor.vue?vue&type=template&id=0095b5af&scoped=true
...
var package_namespaceObject = /*#__PURE__*/JSON.parse('{"UU":"vue-email-editor","rE":"2.0.0"}');
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(EmailEditorvue_type_script_lang_js, [['render',EmailEditorvue_type_template_id_0095b5af_scoped_true_render],['__scopeId',"data-v-0095b5af"]])
